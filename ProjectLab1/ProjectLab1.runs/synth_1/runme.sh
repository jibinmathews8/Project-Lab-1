...
HD_PWD='D:/Jibin/TTU/Fall 2021/Project Lab/ProjectLab1/ProjectLab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Rover_Code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Rover_Code.tcl
