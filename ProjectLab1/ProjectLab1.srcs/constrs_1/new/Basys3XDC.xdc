#//most recent and working constraints
...
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {IN[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {IN[1]}]
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {IN[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {IN[2]}]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {IN[3]}]
...
##Pmod Header JB    
#Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {IR}]
	set_property IOSTANDARD LVCMOS33 [get_ports {IR}]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {JB[1]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {JB[1]}]
#Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {IPS_M}]
...
###Pmod Header JC IPS Sensors
###Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {IPS_M}]
set_property IOSTANDARD LVCMOS33 [get_ports {IPS_M}]
###Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {IPS_M_L}]
set_property IOSTANDARD LVCMOS33 [get_ports {IPS_M_L}]
###Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {IPS_M_R}]
set_property IOSTANDARD LVCMOS33 [get_ports {IPS_M_R}]
###Sch name = JC4
#set_property PACKAGE_PIN P18 [get_ports {IPS_L}]
#set_property IOSTANDARD LVCMOS33 [get_ports {IPS_L}]
###Sch name = JC7
#set_property PACKAGE_PIN L17 [get_ports {IPS_R_R}]
#set_property IOSTANDARD LVCMOS33 [get_ports {IPS_R_R}]
###Sch name = JC8
#set_property PACKAGE_PIN M19 [get_ports {IR}]
#set_property IOSTANDARD LVCMOS33 [get_ports {IR}]
###Sch name = JC9
